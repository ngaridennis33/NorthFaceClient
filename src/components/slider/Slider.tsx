...
const Slider = () => {
    ...
    const prevSlide = () => {
        setcurrSlide(currSlide === 0 ? currSlide : currSlide - 1);
    }

    const nextSlide = () => {
        setcurrSlide(currSlide === numSlides ? currSlide : currSlide + 1);
    }
  ...
  return (
    ...
    <div className={styles.slider}>
        ...
        <div className={styles.icon} onClick={() => handleClick('left')}>
        ...
        <div className={styles.icon} onClick={() => handleClick('right')}>
