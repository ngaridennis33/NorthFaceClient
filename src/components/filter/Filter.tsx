...
const Filter = () => {
  ...
  const mobileFilterContainer = `${styles.mobileFilterLinks} ${openFilterSlider ? styles.showFilterLinksMenu : ""}`;
    ...
    <div className={styles.container}>
      <div className={styles.wrapper}>
        ...
        <div className={styles.mobileFilterIcon} >
          <div className={styles.filterContainer} onClick={toogleFilterSlider}>
            <span className={styles.title}>Filters and Sort</span>
        ...
        <div className={mobileFilterContainer}><MobileFilter openDropDownHandler = {openDropDownHandler} openDropDown={openDropDown} toogleFilterSlider={toogleFilterSlider}/> </div>
